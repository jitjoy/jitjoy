<div style="position: relative; width: 100%; height: 100vh; background: url('https://example.com/your-gif.gif') no-repeat center center fixed; background-size: cover; padding: 20px; color: white;">
